...
The first graph shown below details the information for location effect for the continuous variable.

```{r}
readRDS(  "C:/Users/gavin/Documents/GitHub/myBlog/documents/two_sample_power_files/problem_three_grouptwo_all_view.rds"
          )
