...
description: |
  An application of the Hotelling T2 test where the measurements of the carapaces of painted turtles are compared across sex. Shows a visualization of the utility that accounting for several variables under one technique can have. Includes what can be done when the assumption of equality of covariance matrices is not satisfised. 
...
```{r fig.align='center'}
data %>% select(logwidth,logheight,loglength,sex) %>% ggpairs(aes(color = sex)) 
